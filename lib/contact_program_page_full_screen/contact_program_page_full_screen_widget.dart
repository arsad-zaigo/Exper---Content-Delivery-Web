...
class ContactProgramPageFullScreenWidget extends StatefulWidget {
  const ContactProgramPageFullScreenWidget({Key key}) : super(key: key);

  @override
  _ContactProgramPageFullScreenWidgetState createState() =>
      _ContactProgramPageFullScreenWidgetState();
}

class _ContactProgramPageFullScreenWidgetState
    extends State<ContactProgramPageFullScreenWidget> {
